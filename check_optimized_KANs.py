...
Jacob Maurer
6/26/2026
Purpose: Analyze the KA networks generated from the hyperparameter tuning
"""
from kan import *
...
from optuna_theory_experimental import TheoryEncodedDataset
from vautoencoder_combined_data import VAE
...
if __name__ == "__main__":
    ...
    exp_encoder_str = "4|435->tanh->435|468->tanh->468|3"
    exp_decoder_str = "3|382->tanh->382|377->tanh->377|4"
    exp_encoder_layer = create_layers(exp_encoder_str, {"tanh": nn.Tanh()})
    exp_decoder_layer = create_layers(exp_decoder_str, {"tanh": nn.Tanh()})
    exp_weights = torch.load("./combined_model/vae_experimental_model_2.pt", weights_only=False)()
    ...
    encoder_str = './decoder_kan_smaller_DELETE/0.17'
    transfer_str = 'D:\\KAN_files_2\\transfer_kan_model_89\\0.17'
    decoder_str = 'D:\\KAN_files_2\\decoder_kan_model_89\\0.18'
    encoder = KAN.loadckpt()
    transfer = KAN.loadckpt()
    decoder = KAN.loadckpt()
    ...
    print(encoder)
    print("All models loaded successfully pre-pruning!")